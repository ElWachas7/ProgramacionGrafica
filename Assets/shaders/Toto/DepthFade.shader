	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 temp_cast_0 = (( 1.0 - saturate( pow( ( ( distanceDepth1 + _Bias ) * _Scale ) , _Pow ) ) )).xxxx;
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-518.382,111.2604;Inherit;False;Property;_Scale;Scale;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;-305.2664,-30.482;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
